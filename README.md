adds a menu button for both old and new "top" menus, that's sole purpose is to switch menu types. If you are like me who likes the old style but need to use the new one from time to time, this is for you. There is no nodes , it just adds those two buttons. 
